...
> ### Angular codebase containing real world examples ( The CRUD, auth, advanced patterns, etc) that adheres to the [RealWorld](https://github.com/gothinkster/realworld-example-apps) spec and API.
...
### Making requests to the backend API abdkajdakdb
...
# Getting            iiiiiiiiiiiiiiiiii  started
